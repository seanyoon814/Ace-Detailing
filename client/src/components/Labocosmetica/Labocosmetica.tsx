...
import Labo from "../../images/labocosmetica.jpg"
function Labocosmetica(){
    return(
        <>
        <div className='row justify-content-center'>
            <div className='col-12 text-center pb-5' style={{marginTop:'10vh'}}>
                <img src={Labo} alt='NL272' style={{maxWidth:'100%', maxHeight:'auto'}}></img>
            </div>
        </div>
        <div className='row justify-content-center'>
